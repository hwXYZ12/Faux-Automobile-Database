    ...
    <% 
        if( request.getParameter("SubmitButton") != null)
        {
                 ...
                 && request.getParameter("Role") !=null   )
            {
                ...
                String Query = 
                    "INSERT INTO Employee(EmployeeID, SSN, FirstName, LastName, Address, City, State, ZipCode, Telephone, StartDate, HourlyRate, Role)"+
                    " VALUES (" + employeeID + ", " + ssn + ", '" + firstName + "', '" + lastName + "', '" + address + "', '" + city + "', '" + state + "', " + zipCode + ", '" + telephone + "', " + startDate + ", " + hourlyRate + ", '" + role + "');" ;
