                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                <thead>
                                    ...
                                    Query = 
                                        "SELECT	*"
                                        +" FROM		Advertisement NATURAL JOIN "+
                                        "(SELECT	Type"+
                                        " FROM 	Advertisement NATURAL JOIN Sale NATURAL JOIN"+
                                                        " Account NATURAL JOIN Customer"+
                                        " WHERE 	CustomerID = '"+session.getAttribute("whichCustomer")+"') AS PurchasedType;"
                                    ;
