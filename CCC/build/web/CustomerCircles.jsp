...
<body>
    ...
    <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                String Query = 
                                    "SELECT	CircleID, CircleName, Type" +
                                    " FROM      CircleMembership NATURAL JOIN Circle " +
                                ...
                                %>
                                    <form id="<% out.print("form" + rs.getString(1));%>" method="POST">
                                        ...
                                        <tr data-toggle="tooltip" data-placement="right" title="Click to view this circle!" 
                ...
                <% 
                    // query the database to alert the user to circle invites
                    String q =  "select Count(*) from CircleInvite"
                                    + " where CustomerID='"+session.getAttribute("login")+"';"
                                    ;
                    java.sql.ResultSet x =DBConnection.ExecQuery(q);
                    x.next();
                    
                    // query the database to alert the user to circle requests
                    String q2 = "select Count(*) from"
                                + " CircleRequest NATURAL JOIN Circle"
                                + " where Owner='"+session.getAttribute("login")+"';"
                                ;
                    java.sql.ResultSet y =DBConnection.ExecQuery(q2);
                    y.next();
                %>
                <a class="btn btn-default" href="CreateCircle.jsp">Create a Circle</a>
                <a class="btn btn-default" href="AcceptCircleInvites.jsp">View Circle Invites - <% out.print(x.getInt(1)); %> </a>
                <a class="btn btn-default" href="AcceptCircleRequests.jsp">View Circle Requests - <% out.print(y.getInt(1)); %> </a>
                <a class="btn btn-default" href="SearchForACircle.jsp">Find a Circle</a>
                <a class="btn btn-default" href="DeleteACircle.jsp">Delete a Circle</a>
