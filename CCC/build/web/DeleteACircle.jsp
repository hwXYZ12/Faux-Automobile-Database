                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                %>
                                    ...
                                    %>
                                    <tr>
                                        <th> You don't own any circles! </th>
                                    </tr>
                                    <%
                                }
                                    %>
                                ...
                                %>
                                    <form id="<% out.print("form" + rs.getString(1));%>" method="POST">
                                        ...
                                        <tr data-toggle="tooltip" data-placement="right" title="Click to delete this circle!" 
                                        ...
                                        if (request.getParameter("circle" + rs.getString(1))!=null)
                                        {
                                            ...
                                            Query =  "delete from commentlikes"+
                                                    ...
                                                    + "(select postID from post"+
                                                            " where pageID IN "
                                                    + "(select pageID from page where"
                                                    + " AssociatedCircle='"+rs.getString(1)+"')));"
                                            ;
                                            ...
                                            // delete the page associated with this circle and
                                            // therefore all the posts, comments, likes, etc.
                                            // associated with that page
                                            Query = "delete from page"
                                                    + " where AssociatedCircle='"+rs.getString(1)+"';"
                                                    ;
                                            success = DBConnection.ExecUpdateQuery(Query);
                                            
                                            // delete all circlerequests that reference the circle
                                            Query =  "delete from circlerequest"+
                                                            " where circleID ='"+rs.getString(1)+"';"
                                            ;
                                            success = DBConnection.ExecUpdateQuery(Query);
                                            
                                            // delete all circleinvites that reference the circle
                                            Query =  "delete from circleinvite"+
                                                            " where circleID ='"+rs.getString(1)+"';"
                                            ;
                                            success = DBConnection.ExecUpdateQuery(Query);
                                            
                                            // delete all circlememberships that reference the circle
                                            ...
                                            // refresh the page
                                            response.sendRedirect("DeleteACircle.jsp");
                                            return;
                                        }
                                }
                                    %>
