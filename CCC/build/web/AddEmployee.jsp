                ...
                <form name="formUnique" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-5 col-lg-5">
                            ...
                            <input name="SSN" type="number" min="0" class="form-control" id="SSN">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-5 col-lg-5">
                            ...
                            <input name="ZipCode" type="number" min="0" class="form-control" id="ZipCode">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-5 col-lg-5">
                            ...
                            <input name="HourlyRate" type="number" min="0"
                                   class="form-control" step="0.01" id="HourlyRate">
                        </div>
                    </div>
