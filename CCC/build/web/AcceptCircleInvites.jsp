                            ...
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        String Query = 
                                            "SELECT	CircleID, CustomerID, CircleName" +
                                            " FROM      CircleInvite NATURAL JOIN Circle " +
                                        ...
                                        {
                                        %>
                                        <th> You have no pending invites </th>
                                        <%
                                        }
                                        %>
                                    </tr>
                                ...
                                %>
                                    ...
                                    <tr>
                                        <form id="<% out.print("form" + rs.getString(1) + "x" + rs.getString(2));%>" method="POST">
                                            ...
                                            <td ONCLICK="linkClicked(<% out.print(rs.getString(1) + "," + rs.getString(2));%>)">
