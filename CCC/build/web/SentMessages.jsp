...
<!--                                        <tr data-toggle="tooltip" data-placement="right" title="Click to view this message!" 
...
//                                        {
//                                            session.setAttribute("whichMessage", rs.getString(1));
...
//                                        }
                ...
                <a class="btn btn-default" href="CreateMessage.jsp">Create a Message</a>
                <a class="btn btn-default" href="ReceivedMessages.jsp">View Received Messages </a>
                <a class="btn btn-default" href="DeleteMessage.jsp">Delete a Message </a>
