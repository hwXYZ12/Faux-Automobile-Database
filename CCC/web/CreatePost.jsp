...
<body>
    ...
    <% 
        if(request.getParameter("createAPost") != null) {
            if(request.getParameter("postContent")!=null)
            {
                ...
                // query database for the page id while we know the circle id
                String pageID="";
                ...
                String postAuthor = session.getAttribute("login").toString();
                String content = request.getParameter("postContent");

                Query = 
                    "INSERT INTO Post(PostID, Date, Content, CommentCount, PostAuthor, PageID)"+
                    " VALUES ('"+postID+"', CURDATE(), '"+content+"', '0', '"+postAuthor+"', '"+pageID+"');"
                ;
                int success = DBConnection.ExecUpdateQuery(Query);

                // increment the post count of the page
                Query = "update page set postcount=(postcount+1)"
                        + " where pageID ='"+pageID+"';"
                ;
                success = DBConnection.ExecUpdateQuery(Query);
                
                // now redirect to view posts page
    ...
    <SCRIPT LANGUAGE="JavaScript">
        function button1()
        {
            ...
            if (postContent === "")
            {
                text = "Please enter something to post about!";
                document.getElementById("invalidInput").innerHTML = text;
            } 
            else
            {
                document.form1.createAPost.value = "yes";
                form1.submit();
            }
                ...
                <form name="form1" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-5 col-lg-5">
                            ...
                            <input name="postContent" type="text" class="form-control" id="pcontent">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="HIDDEN" name="createAPost">
                        <input TYPE="BUTTON" class="btn btn-default" value="Create Post" ONCLICK="button1()">
