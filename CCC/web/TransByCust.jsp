        ...
        if( request.getParameter("SubmitButton") != null)
        {
            if  (request.getParameter("FirstName") != null && request.getParameter("LastName") != null)
            {
                ...
                String Query = 
                    ...
                    "CustomerID, TransactionID, DateOfSale AS 'Date of Sale', " +
                    "ItemName AS 'Item Name', " +
                    "NumUnits AS 'Number of Units Purchased' " +
                    "FROM Customer NATURAL JOIN Account NATURAL JOIN Sale " +
                ...
                <SCRIPT LANGUAGE="JavaScript">
                        alert("This person is not a customer!");
                </SCRIPT>
                <%
            }
        }
