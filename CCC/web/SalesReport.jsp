...
<body>
    ...
    <% 
        ...
        {
            if  (request.getParameter("FirstDate") != null && request.getParameter("LastDate") != null)
            {
                ...
                String Query = 
                    "SELECT AdvertisementID, TransactionID, AccountNumber, " +
                    "DateOfSale, Date AS DateAdPlaced, NumUnits, Type, Company, ItemName, UnitPrice " +
                    "FROM Sale NATURAL JOIN Advertisement " +
                    "WHERE DateOfSale >= " + firstDate + " AND DateOfSale < " + lastDate;
                ...
                <form name="formUnique" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-5 col-lg-5">
                            <label for="FirstDate">Begin Date(yyyymmdd): </label>
                            <input name="FirstDate" type="text" class="form-control" id="FirstDate">
                        </div>
                    </div>
                    
                    <div class="row">
                        <div class="form-group col-xs-5 col-lg-5">
                            <label for="LastDate">End Date(yyyymmdd): </label>
                            <input name="LastDate" type="text" class="form-control" id="LastDate">
                        </div>
                    </div>
